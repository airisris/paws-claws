<?php
  ...
  $sql = "SELECT posts.*, categories.name AS category_name 
    FROM posts JOIN users ON posts.user_id = users.id AND posts.user_id = :user_id
...
<?php require "parts/layout.php"; ?>
  <div class="col-9 p-0 m-0">
    <div class="p-3 ps-4 bg-white rounded me-4 position-relative" style="margin-top:100px;">
      <!-- tags -->
      <a href="/"><button class="px-4 py-1 position-absolute rounded-top bg-secondary border-0" style="top:-32px;">All</button></a>
      <a href="/mypost"><button class="px-4 py-1 position-absolute rounded-top bg-white border-0" style="top:-32px; left:100px;">My Post</button></a>
      <!-- message -->
        ...
        <div class="col-4 p-0 mx-0 my-3">
          <div class="card p-0 m-0 overflow-hidden post-card" style="width: 17rem;">
            ...
            <div class="card-body position-relative">
              ...
              <div class="position-absolute d-flex justify-content-end align-items-center gap-2" style="top: -40px; right: 10px;">
                <!-- delete button -->
